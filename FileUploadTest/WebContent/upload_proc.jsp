...
<%
 ...
 if (isMultipart) {                                                                                            // multipart로 전송 되었을 경우
  ...
  String realDir = "C:\\Program Files\\Apache Software Foundation\\Tomcat 7.0\\webapps\\FileUploadTest\\WebContent\\upload";                  //톰켓의 전체 경로를 가져오고 upload라는 폴더를 만들고 거기다
  ...
  upload.setSizeMax(100 * 1024 * 1024);                                                             //최대 파일 크기(10M)
